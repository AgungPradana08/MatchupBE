...
<body>
    ...
    <section class="container sparring-search " >
        <form action="/usersparring/search" class="wrapper" method="get">
            <a href="/usersparring/tambahsparringnew" class="d-none d-lg-flex text-decoration-none align-items-center justify-content-center" style="grid-area: add;">+ Tambah</a>
