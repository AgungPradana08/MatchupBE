    ...
    <section class="title" >
            <div class="title-container">
                <div style="background: red;" >
                    <input class="title-1" name="title" type="text" placeholder="Masukkan Title..."  value="{{$usersparring->title}}" >
                ...
                @error ('olahraga')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
                <input class="title3" type="text" name="deskripsi" placeholder="Masukkan Deskripsi" value="{{$usersparring->deskripsi}}">
                @error ('deskripsi')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
            </div>
        ...
        <section style="margin-top: 5vh;" class="location" >
            ...
            <div class="location-container">
                <input class="title1" type="text" name="lokasi" placeholder="Rincian Lokasi Sparring..." value="{{$usersparring->lokasi}}">
                @error ('lokasi')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
                <div class="map">
        ...
        <section style="margin-top: 5vh;" class="accessibility"  >
            ...
            <div class="access-container">
                <input style="margin-left: 0.1%;"class="ac-title1" type="text" placeholder="Min-Member" name="min_member" value="{{$usersparring->min_member}}">
                @error ('min_member')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
                <input class="ac-title1" type="text" placeholder="Max-member" name="max_member" value="{{$usersparring->max_member}}">
                @error ('max_member')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
        ...
        <section style="margin-top: 5vh;" class="title" >
            ...
            <div class="information-container">
                <input class="info1" id="datepick"  type="date"  placeholder="Tanggal Pertandingan..." name="tanggal_pertandingan" value="{{$usersparring->tanggal_pertandingan}}">
                @error ('tanggal_pertandingan')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
                <input class="info2" type="text" placeholder="Harga Tiket..." name="harga_tiket" value="{{$usersparring->harga_tiket}}">
                @error ('harga_tiket')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
                <input class="info3" type="text" placeholder="Lama Pertandingan..." name="lama_pertandingan" value="{{$usersparring->lama_pertandingan}}">
                @error ('lama_pertandingan')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
                <input class="info3" type="time" placeholder="Waktu Pertandingan..." name="waktu_pertandingan" value="{{$usersparring->waktu_pertandingan}}">
                @error ('waktu_pertandingan')
                        <p class="text-danger" >{{ $message }}</p>
                @enderror
                <input class="info4" type="text" placeholder="Deskripsi Tambahan..." name="deskripsi_tambahan" value="{{$usersparring->deskripsi_tambahan}}">
            </div>
        </section>
