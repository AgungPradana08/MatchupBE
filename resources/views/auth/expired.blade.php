        ...
        <div class="box bg-white p-3 d-flex flex-column align-items-center justify-content-evenly">
            <div class="d-flex flex-column align-items-center" >
                <div class="row d-flex justify-content-evenly align-items-center" style="width: 90%; height: 12vh" >
                    <img class="user-usergood" width="50px" src="/css/img/mailexpired.png" >

                </div>
                <h3 class="fw-bold mt-3" >Pesan Email Telah Expired</h3>
            </div>
            <div class="w-50 d-flex flex-column align-items-center" >
                <a class="btn w-75 text-white" style="visibility: hidden"  href="/sparring/home" style="background: #FE6B00" type="submit">
                    Menuju ke Dashboard
                </a>
            </div>
